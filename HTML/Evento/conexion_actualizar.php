   ...
   /* $update="UPDATE $db_table SET nombre = $nombrec, telefono = $telefonoc, correo = $correoc, direccion = $direccionc 
    ...
    {      
         while($row = mysqli_fetch_array($resultado))
         {
             ...
             $nombrep = $row['Direccion'];
	         $telefonop = $row['Cliente'];
	         $correop = $row['Hora'];
	         $direccionp = $row['Fecha'];
         }
        ...
        echo "<div class = 'div'>"; 
         ...
         echo "<input type='hidden' name='codigo' value='$cedulap' placeholder='Código' />";
         echo "<h1><center>Ingrese los datos del evento para modificar sus datos</center></h1>";           
           
         echo "<input type='text' name='nombre_p' value='$nombrep' placeholder='Dirección' required/>";
         echo "<input type='text' name='telefono_p' value='$telefonop' placeholder='Cliente' required/>";
         echo "<input type='text' name='correo_p' value='$correop' placeholder='Hora' required/>";
         echo "<input type='text' name='direccion_p' value='$direccionp' placeholder='Fecha' required/>";
    ...
    {
        echo "<div class = 'div'>"; 
        echo'<h2>No existe el evento indicado</h2>
        <a href="Home.html">Volver</a>';
        echo "</div>"; 
